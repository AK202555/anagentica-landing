...
export const translations = {
  ...
  cta: {
    ...
    contactLabel: { ru: 'Телефон, Telegram или Email', en: 'Phone, Telegram or Email' },
    contactPlaceholder: { ru: '+7 999 123-45-67, @username или mail@example.ru', en: '+1 555 123-4567, @username or mail@example.com' },
    contactError: { ru: 'Введите телефон, @username или email', en: 'Enter phone, @username or email' },
